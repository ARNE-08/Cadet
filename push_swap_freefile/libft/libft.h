...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/03 21:15:18 by wthanata          #+#    #+#             */
/*   Updated: 2022/08/27 16:48:17 by wthanata         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_putnbrret_base_fd(unsigned int num, char *base,
			int fd, t_flags *set);
int		ft_putluret_base_fd(unsigned long num, char *base, int fd);
int		ft_printf_case(const char *format, t_flags *set, va_list args);
int		case_hash(const char *format, t_flags *set, va_list args, int *i);
int		case_space(const char *format, t_flags *set, va_list args, int *i);
int		case_plus(const char *format, t_flags *set, va_list args, int *i);
